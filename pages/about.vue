<template>
	<div
		...
		<h3
			...
			découvrir et explorer les multiples
			facettes de ta santé mentale et
			sexuelle.
		</h3>
		<p>
			Durant les 25 premières années de ma vie, j'ai vécu sous l'emprise de l'anxiété, de la dépression et des
			traumatismes non diagnostiqués de mon enfance, me perdant dans un flou médical. Dans cette obscurité, je
			me suis souvent sentie incomprise, en proie à une profonde solitude, parfois même détachée du monde qui
			m'entourait.
		</p>
		<p>
			Dans ma vingtaine, j’ai senti émerger une passion pour le développement personnel et la psychologie,
			éclairant peu à peu mon chemin. Entamant un cheminement avec une thérapeute bienveillante et compétente,
			j'ai commencé à mieux me comprendre et à guérir progressivement. Ce cheminement m'a également permis de
			croiser et rencontrer de nombreuses personnes confrontées à des difficultés similaires sur le plan de
			la santé mentale et sexuelle. C'est à ce moment-là que j'ai ressenti un besoin urgent de questionner la
			place de la santé mentale et sexuelle dans notre société. Trop de souffrances demeuraient cachées dans
			le silence, entourées d'un tabou injuste, sans accès à des solutions véritables autre que la résignation
			à vivre avec ce mal-être.
		</p>
		<p>
			...
			dépression. Aujourd'hui, je suis animée par le désir de les partager, offrant ainsi aux personnes
			la possibilité d'explorer leurs ressentis, de légitimer leurs émotions, et de
		...
		<ul>
			...
			<li>LGBTQ+ Friendly & inclusivité</li>
			<li>Adaptabilité & respect du rythme individuel</li>
